...
const Quote = () => {
  return (
    <>
      <section className="py-24 md:pb-28 bg-green-200">
            ...
            <div className="w-full lg:w-2/6 px-4 mb-12 lg:mb-0">
              <div className="relative pt-12 pb-6 sm:p-6">
                ...
                <div className="relative">
                  <h2 className="text-xl text-gray-800 font-semibold tracking-tighter">
                    True partnership between R&D Teams, Supply chain and Brand
                    Promoters is the key to successful new product launch in
                    wellness industry
                  </h2>
                </div>
              </div>
