...
const contact = () => {
  return (
    <div>
      <Header />
      <div className="">
        <section className="pt-20 my-4 bg-green-100">
          <div className="container px-4 mx-auto">
            <div className="max-w-4xl mx-auto mb-16 text-center">
              <span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-green-500 bg-green-100 font-medium uppercase rounded-9xl">
                Contact
              </span>
              <h3 className="mb-4 text-4xl md:text-5xl leading-tight text-darkgray-900 font-bold tracking-tighter">
                Let’s stay connected
              </h3>
              <p className="text-lg md:text-xl text-gray-500 font-medium">
                It&apos;s never been easier to get in touch with Ambica BioKare.
                Call us or email us and we&apos;ll get back to you as soon as
                possible!
              </p>
            </div>
            <div className="flex flex-wrap -mx-4 pb-16">
              <div className="w-full md:w-1/3 px-4 mb-10 md:mb-0">
                <div className="max-w-xs mx-auto text-center">
                  ...
                  <h3 className="mb-2 text-2xl md:text-3xl leading-9 text-gray-800 font-bold">
                    Email
                  </h3>
                  <a
                    className="text-xl text-gray-500 hover:text-gray-600 font-medium"
                    href="mailto:#"
                  >
                    info@ambikabiokare.com
                  </a>
                </div>
              </div>
              <div className="w-full md:w-1/3 px-4 mb-10 md:mb-0">
              ...
              <div className="w-full md:w-1/3 px-4">
                <div className="max-w-xs mx-auto text-center">
                  ...
                  <h3 className="mb-3 text-2xl md:text-3xl font-bold leading-9 text-gray-900">
                    Socials
                  </h3>
                  <a
          ...
          <div className="py-12 bg-blue-200"></div>
        </section>
      </div>
